...
SECRET_KEY = 'django-insecure-brg6c1nzxzo6&2ilykfr5b2zy7p#aoxx)-d0eemkj6b!c$9a4)'
...
LOCAL_APPS = [
    ...
    'apps.editors.apps.EditorsConfig',
]
...
# DIRECTIONS AND URL FOR UPLOADED FILES
MEDIA_URL = '/media/'
...
LOGIN_REDIRECT_URL = reverse_lazy('DashboardView')
